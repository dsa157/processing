...
int PADDING = 40;             // Default: 40 - Padding around the active area
...
// Physics & Grid
float NOISE_SCALE = 0.05;    // Default: 0.005 - Zoom level of noise
...
// Particles
int PARTICLE_COUNT = 400;     // Default: 800
...
boolean INVERT_BG = false;    // Default: false - Swaps index 0 with index 4
