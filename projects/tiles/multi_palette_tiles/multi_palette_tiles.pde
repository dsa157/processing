...
class Tile {
  ...
  void drawShape() {
    ...
    int colorA = hexToColor(currentPalette[1]); 
    int colorB = hexToColor(currentPalette[3]); 
    int colorC = hexToColor(currentPalette[2]); 
